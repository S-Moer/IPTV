...
item_feature = pd.read_csv("data/item_feature.csv",error_bad_lines=False)
len_item_feature = len(item_feature)

movie_test = pd.read_csv("data/movie_test_5-31.csv",error_bad_lines=False)
len_movie_test = len(movie_test)

movie_train = pd.read_csv("data/movie_train_before_5-31.csv",error_bad_lines=False)
len_movie_train = len(movie_train)

user_feature = pd.read_csv("data/user_feature.csv",error_bad_lines=False)
len_user_feature = len(user_feature)

program = pd.read_csv("data/program_20210727.csv",error_bad_lines=False)
len_program = len(program)

raw_train = pd.read_csv("data/train/train_01.csv")
raw_test = pd.read_csv("data/test/test_01.csv")
length_train = len(raw_train)
length_test = len(raw_test)
